...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                @include('common.header-text',['sectiontext' => 'Auto Attendants List'])
            </div>
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">View Auto Attendants</li>
                    </ol>
    ...
    <script type="application/javascript">
        $(document).ready(function(){
            $(document).on("click",".edit_autoattendant", function(){
                ACFn.display_message(
                    "Please contact B1 Support to make changes to your auto attendant.",
                    "Try Again Later",
                    "success","abc",5000);
            });
        });
