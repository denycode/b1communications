    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                @include('common.header-text',['sectiontext' => 'Time Groups List'])
            </div>
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">View Time Groups</li>
                    </ol>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body pb-0">
                        ...
                        <div class="row mb-2" style="border-bottom: 1px solid #dee2e6;">
                            ...
                            >
                                ...
                                <li class="nav-item" style="border-bottom: 1px solid #dee2e6;" >
                                    <a class="nav-link" data-toggle="tab" data-tabid="22" href="#tab_22" role="tab" aria-selected="false">
                                        Day & Night Buttons
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="tab-content br-n pn">
                        ...
                        <div class="tab-pane customtab " id="tab_22" role="tabpanel"></div>
                    </div>
                </div>
            </div>
        </div>
